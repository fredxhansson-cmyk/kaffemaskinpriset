...
export default function Home({ providers, year, month, updated }) {
  ...
  return (
    <>
      <Head>
        <title>Bästa kaffemaskiner 2026 - Hitta din perfekta bryggare</title>
        <meta name="description" content="Upptäck de bästa kaffemaskinerna 2026 ✓ Jämför De'Longhi, Nespresso och fler för ditt perfekta kaffe" />
        <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large" />
        <link rel="canonical" href="https://hemguiden.vercel.app" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Bästa kaffemaskiner 2026 - Hitta din perfekta bryggare" />
        <meta property="og:description" content="Upptäck de bästa kaffemaskinerna 2026 ✓ Jämför De'Longhi, Nespresso och fler för ditt perfekta kaffe" />
        <meta property="og:url" content="https://hemguiden.vercel.app" />
        <meta property="og:locale" content="sv_SE" />
        <meta property="og:site_name" content="Hemguiden" />
        <meta property="og:image" content="https://hemguiden.vercel.app/api/og?title=B%C3%A4sta%20kaffemaskiner%202026%20-%20Hitta%20din%20perfekta%20bryggare&niche=hem" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Bästa kaffemaskiner 2026 - Hitta din perfekta bryggare" />
        <meta name="twitter:description" content="Upptäck de bästa kaffemaskinerna 2026 ✓ Jämför De'Longhi, Nespresso och fler för ditt perfekta kaffe" />
        <meta name="twitter:image" content="https://hemguiden.vercel.app/api/og?title=B%C3%A4sta%20kaffemaskiner%202026%20-%20Hitta%20din%20perfekta%20bryggare&niche=hem" />
        ...
        <div style={{ maxWidth:1100, margin:'0 auto', display:'flex', alignItems:'center',
          ...
          <div style={{ flex:1, minWidth:280 }}>
            ...
            <p style={{ fontSize:18, color:'#475569', lineHeight:1.72,
              ...
              Upptäck de bästa kaffemaskinerna för ditt hem i år.
            </p>
      ...
      <section id="guide" style={{ background:'#f8fafc',
        ...
        <div style={{ maxWidth:760, margin:'0 auto' }}>
          ...
          <p style={{ fontSize:16, lineHeight:1.85, color:'#374151', marginBottom:28 }}>
            När du väljer en kaffemaskin är det viktigt att tänka på dina personliga preferenser och behov. För det första bör du överväga vilken typ av kaffe du föredrar. Om du gillar espresso, kan en maskin som De'Longhi Magnifica Evo vara ett bra val. För dem som föredrar mångsidighet kan Nespresso Vertuo Next vara ett bättre alternativ, eftersom den kan brygga flera olika typer av kaffe. En annan viktig faktor att tänka på är maskinens storlek och design. Om du har begränsat utrymme i ditt kök, vill du kanske satsa på en mer kompakt modell. Slutligen är budgeten en avgörande faktor. Det finns kaffemaskiner i alla prisklasser, så det är viktigt att hitta en modell som passar din budget utan att kompromissa med kvaliteten.
          </p>
          <h3 style={{ fontSize:22, fontWeight:700, marginBottom:16, color:'#0f172a', marginTop:40 }}>Vanliga misstag</h3>
          <p style={{ fontSize:16, lineHeight:1.85, color:'#374151', marginBottom:28 }}>Ett av de vanligaste misstagen när man köper en kaffemaskin är att inte ta hänsyn till underhållskostnaderna. Många glömmer att räkna med priset på kaffekapslar eller bönor, vilket kan bli dyrt i längden. Ett annat misstag är att välja en maskin med för många funktioner, vilket kan göra den svår att använda. Slutligen, att inte läsa recensioner eller göra tillräcklig forskning kan leda till att man köper en modell som inte uppfyller ens behov.</p>
          <h3 style={{ fontSize:20, fontWeight:700, marginBottom:24, color:'#0f172a' }}>
            Vad ska du tänka på?
          </h3>
          <div style={{display:'flex',gap:14,alignItems:'flex-start',marginBottom:16}}><div style={{width:28,height:28,borderRadius:'50%',background:'#0891b215',color:'#0891b2',display:'flex',alignItems:'center',justifyContent:'center',fontWeight:800,fontSize:13,flexShrink:0}}>1</div><p style={{color:'#374151',lineHeight:1.7,fontSize:15}}>Anpassa efter kaffepreferenser</p></div><div style={{display:'flex',gap:14,alignItems:'flex-start',marginBottom:16}}><div style={{width:28,height:28,borderRadius:'50%',background:'#0891b215',color:'#0891b2',display:'flex',alignItems:'center',justifyContent:'center',fontWeight:800,fontSize:13,flexShrink:0}}>2</div><p style={{color:'#374151',lineHeight:1.7,fontSize:15}}>Tänk på köksutrymmet</p></div><div style={{display:'flex',gap:14,alignItems:'flex-start',marginBottom:16}}><div style={{width:28,height:28,borderRadius:'50%',background:'#0891b215',color:'#0891b2',display:'flex',alignItems:'center',justifyContent:'center',fontWeight:800,fontSize:13,flexShrink:0}}>3</div><p style={{color:'#374151',lineHeight:1.7,fontSize:15}}>Jämför underhållskostnader</p></div><div style={{display:'flex',gap:14,alignItems:'flex-start',marginBottom:16}}><div style={{width:28,height:28,borderRadius:'50%',background:'#0891b215',color:'#0891b2',display:'flex',alignItems:'center',justifyContent:'center',fontWeight:800,fontSize:13,flexShrink:0}}>4</div><p style={{color:'#374151',lineHeight:1.7,fontSize:15}}>Läs användarrecensioner</p></div>
        </div>
      </section>
